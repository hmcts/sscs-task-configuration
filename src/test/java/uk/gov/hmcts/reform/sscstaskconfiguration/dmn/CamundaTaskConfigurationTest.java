        ...
        return Stream.of(
            ...
            Arguments.of(
                ...
                ConfigurationExpectationBuilder.defaultExpectations()
                    ...
                    .expectedValue(MAJOR_PRIORITY, "1000", true)
                    .expectedValue(WORK_TYPE, "hearing_work", true)
                    .expectedValue(DESCRIPTION, buildDescription(EventLink.ISSUE_FINAL_DECISION), true)
                    .expectedValue(ROLE_CATEGORY, "JUDICIAL", true)
                    .expectedValue(DUE_DATE_INTERVAL_DAYS, "2", true)
                    .build()
            ),
            Arguments.of(
                "issueAdjournmentNoticeJudge",
                CaseDataBuilder.defaultCase().build(),
                ConfigurationExpectationBuilder.defaultExpectations()
                    .expectedValue(MINOR_PRIORITY, "100", true)
                    .expectedValue(MAJOR_PRIORITY, "1000", true)
                    .expectedValue(WORK_TYPE, "hearing_work", true)
                    .expectedValue(DESCRIPTION, buildDescription(EventLink.ISSUE_ADJOURNMENT_NOTICE), true)
                    .expectedValue(ROLE_CATEGORY, "JUDICIAL", true)
                    .expectedValue(DUE_DATE_INTERVAL_DAYS, "2", true)
                    .build()
            ),
