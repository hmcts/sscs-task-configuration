    ...
    static Stream<Arguments> scenarioProvider() {
        return Stream.of(
            ...
            event("voidCase")
                ...
                .cancel("ftaReplyOverdueIncompleteAppeal")
            ...
            event("decisionIssued")
                ...
                .cancel("reviewFtaValidityChallenge")
                .build(),
            event("tribunalCommunication")
                .cancel("ftaCommunicationId_1234")
                .build(),
            ...
            event("dwpUploadResponse")
                ...
                .build(),
            event("sORRefused")
                .cancel("uploadHearingRecordingSORCTSC")
                .build()
        );
    }
