...
public class Permissions {
    ...
    public static final Map<String, Object> DEFAULT_FEE_PAID_JUDGE_PERMISSIONS = Map.of(
        "name", "fee-paid-judge",
        "value", "Read",
        "autoAssignable", false,
        "roleCategory", "JUDICIAL",
    ...
    public static final Map<String, Object> DEFAULT_SPECIFIC_ACCESS_APPROVER_LEGAL_OPS_PERMISSIONS = Map.of(
        "name", "specific-access-approver-legal-ops",
        "value", "Read",
        "autoAssignable", false,
        "roleCategory", "LEGAL_OPERATIONS"
    );
    public static final Map<String, Object> DEFAULT_SPECIFIC_ACCESS_APPROVER_CTSC_PERMISSIONS = Map.of(
        "name", "specific-access-approver-legal-ops",
        "value", "Read",
        "autoAssignable", false,
        "roleCategory", "CTSC"
    );
    public static final Map<String, Object> DEFAULT_SPECIFIC_ACCESS_APPROVER_ADMIN_PERMISSIONS = Map.of(
        "name", "specific-access-approver-legal-ops",
        "value", "Read",
        "autoAssignable", false,
        "roleCategory", "ADMIN"
    );
    public static final Map<String, Object> DEFAULT_SPECIFIC_ACCESS_APPROVER_JUDICIAL_PERMISSIONS = Map.of(
        "name", "specific-access-approver-legal-ops",
        "value", "Read",
        "autoAssignable", false,
        "roleCategory", "JUDICIAL"
    ...
    public static List<Map<String, Object>> defaultCtscPermissions() {
        return List.of(
            ...
            DEFAULT_FEE_PAID_JUDGE_PERMISSIONS,
            ...
            DEFAULT_SPECIFIC_ACCESS_APPROVER_LEGAL_OPS_PERMISSIONS,
            DEFAULT_SPECIFIC_ACCESS_APPROVER_CTSC_PERMISSIONS,
            DEFAULT_SPECIFIC_ACCESS_APPROVER_ADMIN_PERMISSIONS,
            DEFAULT_SPECIFIC_ACCESS_APPROVER_JUDICIAL_PERMISSIONS,
            Map.of(
                "name", "allocated-ctsc-caseworker",
