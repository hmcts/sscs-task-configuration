...
class CamundaTaskCompletionTest extends DmnDecisionTableBaseUnitTest {
    ...
    @ParameterizedTest
    @CsvSource({"directionIssued", "sendToAdmin", "tcwReferToJudge","strikeOut"})
    void given_multiple_task_type_when_evaluate_dmn(String eventId) {
